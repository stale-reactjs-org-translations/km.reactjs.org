...
មនុស្សចូលមក React មកពី backgrounds ផ្សេងៗគ្នាហើយនិងជាមួយរចនាប័ទ្មសិក្សាខុសៗគ្នា។ មិនថាអ្នកចូលចិត្តទ្រឹស្ឬក៏វិធីសាស្រ្តអនុវត្តជាក់ស្តែង យើងសង្ឃឹមថាអ្នកនឹងរកឃើញផ្នែកនេះមានប្រយោជន៍។

* ប្រសិនបើអ្នកចង់**រៀនដោយការធ្វើ** ចាប់ផ្តើមជាមួយ [ការបង្រៀនជាក់ស្តែង](/tutorial/tutorial.html)។
* ប្រសិនបើអ្នកចង់**រៀនពីគំនិតមួយជំហានម្តង ៗ** ចាប់ផ្តើមជាមួយនឹង [ការណែនាំចំពោះគោលគំនិតសំខាន់ៗរបស់យើង](/docs/hello-world.html)។

ដូចជាបច្ចេកវិទ្យាដែលមិនច្បាស់ផ្សេងៗទៀត, React មានការបង្រផនជាលំដាប់។ ដោយការអនុវត្ជាមួយការអត់ធ្មត់ អ្នក*នឹង*ទទួលបានជំនាញពី React។
